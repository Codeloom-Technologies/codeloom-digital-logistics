  ...
  const officeInfo = [
    {
      icon: MapPin,
      title: "Head Office",
      details: ["123 Innovation Drive", "Tech District, Lagos", "Nigeria"]
    },
    {
      icon: Clock,
    ...
    },
    {
      icon: Users,
      title: "Support Team",
      details: ["Technical Support 24/7", "Sales Team Available", "Project Management"]
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {contactMethods.map((method, index) => {
              ...
              return (
                <Card key={index} className="group hover:shadow-card transition-all duration-300 hover:-translate-y-1 border-0 bg-card/50 backdrop-blur-sm text-center">
                  <CardContent className="p-8">
                    <div className={`w-16 h-16 bg-gradient-to-br ${method.gradient} rounded-full flex items-center justify-center mx-auto mb-6 group-hover:shadow-glow transition-all duration-300`}>
              ...
              <CardContent className="p-8">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <select id="service" className="w-full mt-1 px-3 py-2 bg-background border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-ring">
              ...
              <Card className="border-0 bg-gradient-to-br from-primary/5 to-primary/10">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h4 className="font-semibold text-foreground">Quick Response Promise</h4>
                  </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">Located in the heart of Lagos' tech district</p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
            Ready to start your project? Our team is standing by to help bring your vision to life.
          </p>
